"""This module deals with visualising results for the bootstrapping."""
import pandas as pd
import numpy as np
import torch
...
class Visual:
    """
    This class deals with creating confusion matricies and box plots for the various tests ran with the bootstrapping module.
